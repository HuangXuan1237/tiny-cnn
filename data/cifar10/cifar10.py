...
def main():
    ...
    train_images.tofile("./data/cifar10/train/train_images.mat")
    train_labels.tofile("./data/cifar10/train/train_labels.mat")
    ...
    val_images.tofile("./data/cifar10/train/val_images.mat")
    val_labels.tofile("./data/cifar10/train/val_labels.mat")
