...
dataset *dset_subset(arena *ar, const dataset *ds, size_t class_count, const int *selected_classes);

dataloader *dloader_create(arena *ar, const dataset *ds, size_t batch_size, bool shuffle);
